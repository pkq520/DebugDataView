...
namespace DebugDataView.Commands
{
    ...
    internal sealed class DataViewItemAdd : BaseCommand<DataViewItemAdd>
    {
        ...
        protected override async Task ExecuteAsync(OleMenuCmdEventArgs e)
        {
            ...
            {
                if (!debugDataView.ProgramLanguageDetection())
                {
                ...
                if (await debugDataView.ValueTypeDetectionAsync(selected) == false)
                {
                ...
                {
                    debugDataView.Init(dataViewWindow);
                    await debugDataView.DataViewItemAddAsync(selected);
                }
            }
        }
